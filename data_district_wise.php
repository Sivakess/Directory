...
echo " entered district is $district";
    // SQL query to retrieve data for the entered district
    $sql = "SELECT const, vpt, bpt, cpc FROM `assembly` WHERE dist='$district'";
    ...
    if ($result) {
        ...
        echo "<h2 style='text-align: center;'>Assembly Information for $district</h2>"; // Centering the heading
