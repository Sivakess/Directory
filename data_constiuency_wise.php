...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Get the entered 
    $Constiuencywise = $_POST['Constiuencywise'];
echo " entered Constiuencywise is $Constiuencywise";
    // SQL query to retrieve data for the entered
    $sql = "SELECT dist, const, vpt, bpt, cpc FROM `assembly` WHERE const='$Constiuencywise'";
...
if ($result) {
    ...
    echo "<h2 style='text-align: center;'>Assembly Information for $Constiuencywise</h2>"; // Centering the heading
