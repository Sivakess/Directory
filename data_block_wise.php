...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $block = $_POST['block'];
echo " entered block is $block";
    // SQL query to retrieve data for the entered district
    $sql = "SELECT dist, const, vpt, bpt, cpc FROM `assembly` WHERE bpt='$block'";
...
if ($result) {
    ...
    echo "<h2 style='text-align: center;'>Assembly Information for $block</h2>"; // Centering the heading
